...
},{"./lib/ReactPropTypesSecret":35}],11:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithThrowingShims":29}],37:[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"object-assign":37,"fbjs/lib/invariant":39,"fbjs/lib/emptyObject":41,"fbjs/lib/emptyFunction":43}],13:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":27}],3:[function(require,module,exports) {
...
function FontAwesomeIcon(props) {
  ...
  var renderedIcon = (0, _fontawesomeSvgCore.icon)(iconLookup, _extends({}, classes, transform, mask, {
    symbol: symbol
  }));
...
},{"@fortawesome/fontawesome-svg-core":7,"prop-types":11,"react":13}],5:[function(require,module,exports) {
'use strict';
...
},{"isobject":33}],15:[function(require,module,exports) {
var define;
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
...
},{"./cjs/react-is.production.min.js":31}],21:[function(require,module,exports) {
...
var parentNodeUnmountedErr = 'production' !== 'production' ? '\nTrying to insert a new style tag, but the given Node is unmounted!\n- Are you using a custom target that isn\'t mounted?\n- Does your document not have a valid head element?\n- Have you accidentally removed a style tag manually?\n'.trim() : '';
...
// 
/* this error is used for makeStyleTag */
var targetPropErr = 'production' !== 'production' ? '\nThe StyleSheetManager expects a valid target or sheet prop!\n- Does this error occur on the client and is your target falsy?\n- Does this error occur on the server and is the sheet falsy?\n'.trim() : '';
...
/* this error is used for makeStyleTag */
var sheetClosedErr = 'production' !== 'production' ? '\nCan\'t collect styles once you\'ve consumed a ServerStyleSheet\'s styles!\nServerStyleSheet is a one off instance for each server-side render cycle.\n- Are you trying to reuse it across renders?\n- Are you accidentally calling collectStyles twice?\n'.trim() : '';

var streamBrowserErr = 'production' !== 'production' ? 'Streaming SSR is only supported in a Node.js environment; Please do not try to call this method in the browser.' : '';
  ...
  ThemeProvider.prototype.getTheme = function getTheme(passedTheme) {
    ...
    if (isFunction(theme)) {
      ...
      if ('production' !== 'production' && (mergedTheme === null || Array.isArray(mergedTheme) || (typeof mergedTheme === 'undefined' ? 'undefined' : _typeof(mergedTheme)) !== 'object')) {
        throw new Error('production' !== 'production' ? '[ThemeProvider] Please return an object from your theme function, i.e. theme={() => ({})}!' : '');
      }
      return mergedTheme;
    }
    if (theme === null || Array.isArray(theme) || (typeof theme === 'undefined' ? 'undefined' : _typeof(theme)) !== 'object') {
      throw new Error('production' !== 'production' ? '[ThemeProvider] Please make your theme prop an object' : '');
    }
...
var _constructWithOptions = function (css) {
  var constructWithOptions = function constructWithOptions(componentConstructor, tag) {
    ...
    if (!(0, _reactIs.isValidElementType)(tag)) {
      throw new Error('production' !== 'production' ? 'Cannot create styled-component for component: ' + String(tag) : '');
    }
...
},{"is-plain-object":17,"stylis":15,"stylis-rule-sheet":19,"react":13,"prop-types":11,"hoist-non-react-statics":23,"react-is":25,"process":21}],1:[function(require,module,exports) {
'use strict';
...
_fontawesomeSvgCore.library.add(_freeSolidSvgIcons.faArchive, _freeSolidSvgIcons.faChevronDown);

var Icon = (0, _styledComponents2.default)(_reactFontawesome.FontAwesomeIcon).withConfig({
	displayName: 'parcel-issue1664-fontawesome-treeshake__Icon'
})(['']);

exports.default = Icon;
},{"@fortawesome/react-fontawesome":3,"@fortawesome/fontawesome-svg-core":7,"@fortawesome/free-solid-svg-icons":5,"styled-components":9}]},{},[1], null)
